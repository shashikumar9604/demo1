package Application_emailVerification;
...
public class EmailValidation {
    static String [] dataBase= {"shashi@wwc.com","vinay@Gmail.com","raghu@outlook.net"};


	public static void main(String[] args) {
        System.out.println("---- Welecome To ID Verfication app by Shashikumar--- ");
